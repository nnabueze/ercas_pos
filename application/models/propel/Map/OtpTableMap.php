...
class OtpTableMap extends TableMap
{
     ...
     */
    const COL_ACCOUNT_NO = 'otp.account_no';

    /**
     * the column name for the opt field
     */
    const COL_OPT = 'otp.opt';

    /**
     * the column name for the Status field
     */
    const COL_STATUS = 'otp.Status';

    /**
     * the column name for the date_created field
     */
    const COL_DATE_CREATED = 'otp.date_created';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'AccountNo', 'Opt', 'Status', 'DateCreated', ),
        self::TYPE_CAMELNAME     => array('id', 'accountNo', 'opt', 'status', 'dateCreated', ),
        self::TYPE_COLNAME       => array(OtpTableMap::COL_ID, OtpTableMap::COL_ACCOUNT_NO, OtpTableMap::COL_OPT, OtpTableMap::COL_STATUS, OtpTableMap::COL_DATE_CREATED, ),
        self::TYPE_FIELDNAME     => array('id', 'account_no', 'opt', 'Status', 'date_created', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'AccountNo' => 1, 'Opt' => 2, 'Status' => 3, 'DateCreated' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'accountNo' => 1, 'opt' => 2, 'status' => 3, 'dateCreated' => 4, ),
        self::TYPE_COLNAME       => array(OtpTableMap::COL_ID => 0, OtpTableMap::COL_ACCOUNT_NO => 1, OtpTableMap::COL_OPT => 2, OtpTableMap::COL_STATUS => 3, OtpTableMap::COL_DATE_CREATED => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'account_no' => 1, 'opt' => 2, 'Status' => 3, 'date_created' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Otp');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('account_no', 'AccountNo', 'VARCHAR', true, 50, null);
        $this->addColumn('opt', 'Opt', 'INTEGER', true, null, null);
        $this->addColumn('Status', 'Status', 'VARCHAR', true, 10, null);
        $this->addColumn('date_created', 'DateCreated', 'DATE', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OtpTableMap::COL_ACCOUNT_NO);
            $criteria->addSelectColumn(OtpTableMap::COL_OPT);
            $criteria->addSelectColumn(OtpTableMap::COL_STATUS);
            $criteria->addSelectColumn(OtpTableMap::COL_DATE_CREATED);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.account_no');
            $criteria->addSelectColumn($alias . '.opt');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Otp) { // it's a model object
