...
class AccessTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'access.id';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'access.key';

    /**
     * the column name for the controller field
     */
    const COL_CONTROLLER = 'access.controller';

    /**
     * the column name for the date_created field
     */
    const COL_DATE_CREATED = 'access.date_created';

    /**
     * the column name for the date_modified field
     */
    const COL_DATE_MODIFIED = 'access.date_modified';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Key', 'Controller', 'DateCreated', 'DateModified', ),
        self::TYPE_CAMELNAME     => array('id', 'key', 'controller', 'dateCreated', 'dateModified', ),
        self::TYPE_COLNAME       => array(AccessTableMap::COL_ID, AccessTableMap::COL_KEY, AccessTableMap::COL_CONTROLLER, AccessTableMap::COL_DATE_CREATED, AccessTableMap::COL_DATE_MODIFIED, ),
        self::TYPE_FIELDNAME     => array('id', 'key', 'controller', 'date_created', 'date_modified', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Key' => 1, 'Controller' => 2, 'DateCreated' => 3, 'DateModified' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'key' => 1, 'controller' => 2, 'dateCreated' => 3, 'dateModified' => 4, ),
        self::TYPE_COLNAME       => array(AccessTableMap::COL_ID => 0, AccessTableMap::COL_KEY => 1, AccessTableMap::COL_CONTROLLER => 2, AccessTableMap::COL_DATE_CREATED => 3, AccessTableMap::COL_DATE_MODIFIED => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'key' => 1, 'controller' => 2, 'date_created' => 3, 'date_modified' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('key', 'Key', 'VARCHAR', true, 40, '');
        $this->addColumn('controller', 'Controller', 'VARCHAR', true, 50, '');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AccessTableMap::COL_KEY);
            $criteria->addSelectColumn(AccessTableMap::COL_CONTROLLER);
            $criteria->addSelectColumn(AccessTableMap::COL_DATE_CREATED);
            $criteria->addSelectColumn(AccessTableMap::COL_DATE_MODIFIED);
        } else {
