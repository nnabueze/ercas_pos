...
abstract class Access implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AccessTableMap';
    ...
    /**
     * Initializes internal state of Base\Access object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Access The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AccessTableMap::COL_ID] = true;
        }
    ...
    public function setKey($v)
    {
        ...
        if ($this->key !== $v) {
            $this->key = $v;
            $this->modifiedColumns[AccessTableMap::COL_KEY] = true;
        }
    ...
    public function setController($v)
    {
        ...
        if ($this->controller !== $v) {
            $this->controller = $v;
            $this->modifiedColumns[AccessTableMap::COL_CONTROLLER] = true;
        }
    ...
    public function setDateCreated($v)
    {
        ...
        if ($this->date_created !== null || $dt !== null) {
            if ($this->date_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AccessTableMap::COL_DATE_CREATED] = true;
            }
    ...
    public function setDateModified($v)
    {
        ...
        if ($this->date_modified !== null || $dt !== null) {
            if ($this->date_modified === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_modified->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AccessTableMap::COL_DATE_MODIFIED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AccessTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AccessTableMap::translateFieldName('Key', TableMap::TYPE_PHPNAME, $indexType)];
            $this->key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AccessTableMap::translateFieldName('Controller', TableMap::TYPE_PHPNAME, $indexType)];
            $this->controller = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AccessTableMap::translateFieldName('DateCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AccessTableMap::translateFieldName('DateModified', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Access'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AccessTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AccessTableMap::COL_KEY)) {
            $modifiedColumns[':p' . $index++]  = 'key';
        }
        if ($this->isColumnModified(AccessTableMap::COL_CONTROLLER)) {
            $modifiedColumns[':p' . $index++]  = 'controller';
        }
        if ($this->isColumnModified(AccessTableMap::COL_DATE_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_created';
        }
        if ($this->isColumnModified(AccessTableMap::COL_DATE_MODIFIED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AccessTableMap::COL_ID)) {
            $criteria->add(AccessTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AccessTableMap::COL_KEY)) {
            $criteria->add(AccessTableMap::COL_KEY, $this->key);
        }
        if ($this->isColumnModified(AccessTableMap::COL_CONTROLLER)) {
            $criteria->add(AccessTableMap::COL_CONTROLLER, $this->controller);
        }
        if ($this->isColumnModified(AccessTableMap::COL_DATE_CREATED)) {
            $criteria->add(AccessTableMap::COL_DATE_CREATED, $this->date_created);
        }
        if ($this->isColumnModified(AccessTableMap::COL_DATE_MODIFIED)) {
            $criteria->add(AccessTableMap::COL_DATE_MODIFIED, $this->date_modified);
        }
