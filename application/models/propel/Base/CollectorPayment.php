...
/**
 * Base class that represents a row from the 'collector_payment' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class CollectorPayment implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CollectorPaymentTableMap';
    ...
    /**
     * Initializes internal state of Base\CollectorPayment object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CollectorPayment</code> instance.  If
     * <code>obj</code> is an instance of <code>CollectorPayment</code>, delegates to
     * <code>equals(CollectorPayment)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CollectorPayment The current object, for fluid interface
     */
     ...
     * @return $this|\CollectorPayment The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_ID] = true;
        }
    ...
    public function setCollectorId($v)
    {
        ...
        if ($this->collector_id !== $v) {
            $this->collector_id = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_COLLECTOR_ID] = true;
        }
    ...
    public function setAccountNo($v)
    {
        ...
        if ($this->account_no !== $v) {
            $this->account_no = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_ACCOUNT_NO] = true;
        }
    ...
    public function setBillreferencenumber($v)
    {
        ...
        if ($this->billreferencenumber !== $v) {
            ...
            $this->modifiedColumns[CollectorPaymentTableMap::COL_BILLREFERENCENUMBER] = true;
        }
    ...
    public function setTransactionid($v)
    {
        ...
        if ($this->transactionid !== $v) {
            ...
            $this->modifiedColumns[CollectorPaymentTableMap::COL_TRANSACTIONID] = true;
        }
    ...
    public function setSourcebank($v)
    {
        ...
        if ($this->sourcebank !== $v) {
            $this->sourcebank = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_SOURCEBANK] = true;
        }
    ...
    public function setDestinationbank($v)
    {
        ...
        if ($this->destinationbank !== $v) {
            ...
            $this->modifiedColumns[CollectorPaymentTableMap::COL_DESTINATIONBANK] = true;
        }
    ...
    public function setBuildingtype($v)
    {
        ...
        if ($this->buildingtype !== $v) {
            $this->buildingtype = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_BUILDINGTYPE] = true;
        }
    ...
    public function setCustomername($v)
    {
        ...
        if ($this->customername !== $v) {
            $this->customername = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_CUSTOMERNAME] = true;
        }
    ...
    public function setDistrict($v)
    {
        ...
        if ($this->district !== $v) {
            $this->district = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_DISTRICT] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_EMAIL] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_PHONE] = true;
        }
    ...
    public function setOutstandingbalance($v)
    {
        ...
        if ($this->outstandingbalance !== $v) {
            ...
            $this->modifiedColumns[CollectorPaymentTableMap::COL_OUTSTANDINGBALANCE] = true;
        }
    ...
    public function setTransactiondate($v)
    {
        ...
        if ($this->transactiondate !== null || $dt !== null) {
            if ($this->transactiondate === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->transactiondate->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CollectorPaymentTableMap::COL_TRANSACTIONDATE] = true;
            }
    ...
    public function setDateInitiated($v)
    {
        ...
        if ($this->date_initiated !== $v) {
            ...
            $this->modifiedColumns[CollectorPaymentTableMap::COL_DATE_INITIATED] = true;
        }
    ...
    public function setDateCompleted($v)
    {
        ...
        if ($this->date_completed !== $v) {
            ...
            $this->modifiedColumns[CollectorPaymentTableMap::COL_DATE_COMPLETED] = true;
        }
    ...
    public function setAmountPaid($v)
    {
        ...
        if ($this->amount_paid !== $v) {
            $this->amount_paid = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_AMOUNT_PAID] = true;
        }
    ...
    public function setAmountdue($v)
    {
        ...
        if ($this->amountdue !== $v) {
            $this->amountdue = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_AMOUNTDUE] = true;
        }
    ...
    public function setPlatform($v)
    {
        ...
        if ($this->platform !== $v) {
            $this->platform = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_PLATFORM] = true;
        }
    ...
    public function setReceiptNo($v)
    {
        ...
        if ($this->receipt_no !== $v) {
            $this->receipt_no = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_RECEIPT_NO] = true;
        }
    ...
    public function setServiceaddress($v)
    {
        ...
        if ($this->serviceaddress !== $v) {
            ...
            $this->modifiedColumns[CollectorPaymentTableMap::COL_SERVICEADDRESS] = true;
        }
    ...
    public function setUsagetype($v)
    {
        ...
        if ($this->usagetype !== $v) {
            $this->usagetype = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_USAGETYPE] = true;
        }
    ...
    public function setPaymentStatus($v)
    {
        ...
        if ($this->payment_status !== $v) {
            ...
            $this->modifiedColumns[CollectorPaymentTableMap::COL_PAYMENT_STATUS] = true;
        }
    ...
    public function setReconcileStatus($v)
    {
        ...
        if ($this->reconcile_status !== $v) {
            ...
            $this->modifiedColumns[CollectorPaymentTableMap::COL_RECONCILE_STATUS] = true;
        }
    ...
    public function setCreatedDate($v)
    {
        ...
        if ($this->created_date !== null || $dt !== null) {
            if ($this->created_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CollectorPaymentTableMap::COL_CREATED_DATE] = true;
            }
        } // if either are not null
    ...
    public function setUploadstatus($v)
    {
        ...
        if ($this->uploadstatus !== $v) {
            $this->uploadstatus = $v;
            $this->modifiedColumns[CollectorPaymentTableMap::COL_UPLOADSTATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CollectorPaymentTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CollectorPaymentTableMap::translateFieldName('CollectorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->collector_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CollectorPaymentTableMap::translateFieldName('AccountNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->account_no = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CollectorPaymentTableMap::translateFieldName('Billreferencenumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billreferencenumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CollectorPaymentTableMap::translateFieldName('Transactionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transactionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CollectorPaymentTableMap::translateFieldName('Sourcebank', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sourcebank = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CollectorPaymentTableMap::translateFieldName('Destinationbank', TableMap::TYPE_PHPNAME, $indexType)];
            $this->destinationbank = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CollectorPaymentTableMap::translateFieldName('Buildingtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->buildingtype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CollectorPaymentTableMap::translateFieldName('Customername', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customername = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CollectorPaymentTableMap::translateFieldName('District', TableMap::TYPE_PHPNAME, $indexType)];
            $this->district = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CollectorPaymentTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CollectorPaymentTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CollectorPaymentTableMap::translateFieldName('Outstandingbalance', TableMap::TYPE_PHPNAME, $indexType)];
            $this->outstandingbalance = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CollectorPaymentTableMap::translateFieldName('Transactiondate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->transactiondate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CollectorPaymentTableMap::translateFieldName('DateInitiated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date_initiated = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : CollectorPaymentTableMap::translateFieldName('DateCompleted', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date_completed = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : CollectorPaymentTableMap::translateFieldName('AmountPaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount_paid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : CollectorPaymentTableMap::translateFieldName('Amountdue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amountdue = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : CollectorPaymentTableMap::translateFieldName('Platform', TableMap::TYPE_PHPNAME, $indexType)];
            $this->platform = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : CollectorPaymentTableMap::translateFieldName('ReceiptNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->receipt_no = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : CollectorPaymentTableMap::translateFieldName('Serviceaddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->serviceaddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : CollectorPaymentTableMap::translateFieldName('Usagetype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usagetype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : CollectorPaymentTableMap::translateFieldName('PaymentStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : CollectorPaymentTableMap::translateFieldName('ReconcileStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reconcile_status = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : CollectorPaymentTableMap::translateFieldName('CreatedDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : CollectorPaymentTableMap::translateFieldName('Uploadstatus', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 26; // 26 = CollectorPaymentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CollectorPayment'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCollectorPaymentQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CollectorPayment::setDeleted()
     * @see CollectorPayment::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCollectorPaymentQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CollectorPaymentTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_COLLECTOR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'collector_id';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_ACCOUNT_NO)) {
            $modifiedColumns[':p' . $index++]  = 'account_no';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_BILLREFERENCENUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'BillReferenceNumber';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_TRANSACTIONID)) {
            $modifiedColumns[':p' . $index++]  = 'TransactionID';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_SOURCEBANK)) {
            $modifiedColumns[':p' . $index++]  = 'SourceBank';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_DESTINATIONBANK)) {
            $modifiedColumns[':p' . $index++]  = 'DestinationBank';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_BUILDINGTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'BuildingType';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_CUSTOMERNAME)) {
            $modifiedColumns[':p' . $index++]  = 'CustomerName';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_DISTRICT)) {
            $modifiedColumns[':p' . $index++]  = 'District';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'Email';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'Phone';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_OUTSTANDINGBALANCE)) {
            $modifiedColumns[':p' . $index++]  = 'OutstandingBalance';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_TRANSACTIONDATE)) {
            $modifiedColumns[':p' . $index++]  = 'TransactionDate';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_DATE_INITIATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_initiated';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_DATE_COMPLETED)) {
            $modifiedColumns[':p' . $index++]  = 'date_completed';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_AMOUNT_PAID)) {
            $modifiedColumns[':p' . $index++]  = 'amount_paid';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_AMOUNTDUE)) {
            $modifiedColumns[':p' . $index++]  = 'AmountDue';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_PLATFORM)) {
            $modifiedColumns[':p' . $index++]  = 'platform';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_RECEIPT_NO)) {
            $modifiedColumns[':p' . $index++]  = 'receipt_no';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_SERVICEADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'ServiceAddress';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_USAGETYPE)) {
            $modifiedColumns[':p' . $index++]  = 'UsageType';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_PAYMENT_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'payment_status';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_RECONCILE_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'reconcile_status';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_CREATED_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'created_date';
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_UPLOADSTATUS)) {
            $modifiedColumns[':p' . $index++]  = 'uploadstatus';
        }

        $sql = sprintf(
            'INSERT INTO collector_payment (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'collector_id':
                        $stmt->bindValue($identifier, $this->collector_id, PDO::PARAM_STR);
                        break;
                    case 'account_no':
    ...
    {
        $pos = CollectorPaymentTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CollectorPayment'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CollectorPayment'][$this->hashCode()] = true;
        $keys = CollectorPaymentTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setCollectorId($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_ID)) {
            $criteria->add(CollectorPaymentTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_COLLECTOR_ID)) {
            $criteria->add(CollectorPaymentTableMap::COL_COLLECTOR_ID, $this->collector_id);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_ACCOUNT_NO)) {
            $criteria->add(CollectorPaymentTableMap::COL_ACCOUNT_NO, $this->account_no);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_BILLREFERENCENUMBER)) {
            $criteria->add(CollectorPaymentTableMap::COL_BILLREFERENCENUMBER, $this->billreferencenumber);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_TRANSACTIONID)) {
            $criteria->add(CollectorPaymentTableMap::COL_TRANSACTIONID, $this->transactionid);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_SOURCEBANK)) {
            $criteria->add(CollectorPaymentTableMap::COL_SOURCEBANK, $this->sourcebank);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_DESTINATIONBANK)) {
            $criteria->add(CollectorPaymentTableMap::COL_DESTINATIONBANK, $this->destinationbank);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_BUILDINGTYPE)) {
            $criteria->add(CollectorPaymentTableMap::COL_BUILDINGTYPE, $this->buildingtype);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_CUSTOMERNAME)) {
            $criteria->add(CollectorPaymentTableMap::COL_CUSTOMERNAME, $this->customername);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_DISTRICT)) {
            $criteria->add(CollectorPaymentTableMap::COL_DISTRICT, $this->district);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_EMAIL)) {
            $criteria->add(CollectorPaymentTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_PHONE)) {
            $criteria->add(CollectorPaymentTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_OUTSTANDINGBALANCE)) {
            $criteria->add(CollectorPaymentTableMap::COL_OUTSTANDINGBALANCE, $this->outstandingbalance);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_TRANSACTIONDATE)) {
            $criteria->add(CollectorPaymentTableMap::COL_TRANSACTIONDATE, $this->transactiondate);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_DATE_INITIATED)) {
            $criteria->add(CollectorPaymentTableMap::COL_DATE_INITIATED, $this->date_initiated);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_DATE_COMPLETED)) {
            $criteria->add(CollectorPaymentTableMap::COL_DATE_COMPLETED, $this->date_completed);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_AMOUNT_PAID)) {
            $criteria->add(CollectorPaymentTableMap::COL_AMOUNT_PAID, $this->amount_paid);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_AMOUNTDUE)) {
            $criteria->add(CollectorPaymentTableMap::COL_AMOUNTDUE, $this->amountdue);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_PLATFORM)) {
            $criteria->add(CollectorPaymentTableMap::COL_PLATFORM, $this->platform);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_RECEIPT_NO)) {
            $criteria->add(CollectorPaymentTableMap::COL_RECEIPT_NO, $this->receipt_no);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_SERVICEADDRESS)) {
            $criteria->add(CollectorPaymentTableMap::COL_SERVICEADDRESS, $this->serviceaddress);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_USAGETYPE)) {
            $criteria->add(CollectorPaymentTableMap::COL_USAGETYPE, $this->usagetype);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_PAYMENT_STATUS)) {
            $criteria->add(CollectorPaymentTableMap::COL_PAYMENT_STATUS, $this->payment_status);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_RECONCILE_STATUS)) {
            $criteria->add(CollectorPaymentTableMap::COL_RECONCILE_STATUS, $this->reconcile_status);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_CREATED_DATE)) {
            $criteria->add(CollectorPaymentTableMap::COL_CREATED_DATE, $this->created_date);
        }
        if ($this->isColumnModified(CollectorPaymentTableMap::COL_UPLOADSTATUS)) {
            $criteria->add(CollectorPaymentTableMap::COL_UPLOADSTATUS, $this->uploadstatus);
        }
    ...
    {
        $criteria = ChildCollectorPaymentQuery::create();
        $criteria->add(CollectorPaymentTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CollectorPayment (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CollectorPayment Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CollectorPaymentTableMap::DEFAULT_STRING_FORMAT);
    }
