...
abstract class Payment implements ActiveRecordInterface
{
    ...
    public function setAccountNo($v)
    {
        ...
        if ($this->account_no !== $v) {
            $this->account_no = $v;
            $this->modifiedColumns[PaymentTableMap::COL_ACCOUNT_NO] = true;
        }
    ...
    public function setBillreferencenumber($v)
    {
        ...
        if ($this->billreferencenumber !== $v) {
            ...
            $this->modifiedColumns[PaymentTableMap::COL_BILLREFERENCENUMBER] = true;
        }
    ...
    public function setTransactionid($v)
    {
        ...
        if ($this->transactionid !== $v) {
            ...
            $this->modifiedColumns[PaymentTableMap::COL_TRANSACTIONID] = true;
        }
    ...
    public function setSourcebank($v)
    {
        ...
        if ($this->sourcebank !== $v) {
            $this->sourcebank = $v;
            $this->modifiedColumns[PaymentTableMap::COL_SOURCEBANK] = true;
        }
    ...
    public function setDestinationbank($v)
    {
        ...
        if ($this->destinationbank !== $v) {
            ...
            $this->modifiedColumns[PaymentTableMap::COL_DESTINATIONBANK] = true;
        }
    ...
    public function setBuildingtype($v)
    {
        ...
        if ($this->buildingtype !== $v) {
            $this->buildingtype = $v;
            $this->modifiedColumns[PaymentTableMap::COL_BUILDINGTYPE] = true;
        }
    ...
    public function setCustomername($v)
    {
        ...
        if ($this->customername !== $v) {
            $this->customername = $v;
            $this->modifiedColumns[PaymentTableMap::COL_CUSTOMERNAME] = true;
        }
    ...
    public function setDistrict($v)
    {
        ...
        if ($this->district !== $v) {
            $this->district = $v;
            $this->modifiedColumns[PaymentTableMap::COL_DISTRICT] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[PaymentTableMap::COL_PHONE] = true;
        }
    ...
    public function setOutstandingbalance($v)
    {
        ...
        if ($this->outstandingbalance !== $v) {
            ...
            $this->modifiedColumns[PaymentTableMap::COL_OUTSTANDINGBALANCE] = true;
        }
    ...
    public function setTransactiondate($v)
    {
        ...
        if ($this->transactiondate !== null || $dt !== null) {
            if ($this->transactiondate === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->transactiondate->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PaymentTableMap::COL_TRANSACTIONDATE] = true;
            }
    ...
    public function setDateInitiated($v)
    {
        ...
        if ($this->date_initiated !== $v) {
            ...
            $this->modifiedColumns[PaymentTableMap::COL_DATE_INITIATED] = true;
        }
    ...
    public function setDateCompleted($v)
    {
        ...
        if ($this->date_completed !== $v) {
            ...
            $this->modifiedColumns[PaymentTableMap::COL_DATE_COMPLETED] = true;
        }
    ...
    public function setAmountPaid($v)
    {
        ...
        if ($this->amount_paid !== $v) {
            $this->amount_paid = $v;
            $this->modifiedColumns[PaymentTableMap::COL_AMOUNT_PAID] = true;
        }
    ...
    public function setAmountdue($v)
    {
        ...
        if ($this->amountdue !== $v) {
            $this->amountdue = $v;
            $this->modifiedColumns[PaymentTableMap::COL_AMOUNTDUE] = true;
        }
    ...
    public function setPlatform($v)
    {
        ...
        if ($this->platform !== $v) {
            $this->platform = $v;
            $this->modifiedColumns[PaymentTableMap::COL_PLATFORM] = true;
        }
    ...
    public function setReceiptNo($v)
    {
        ...
        if ($this->receipt_no !== $v) {
            $this->receipt_no = $v;
            $this->modifiedColumns[PaymentTableMap::COL_RECEIPT_NO] = true;
        }
    ...
    public function setServiceaddress($v)
    {
        ...
        if ($this->serviceaddress !== $v) {
            ...
            $this->modifiedColumns[PaymentTableMap::COL_SERVICEADDRESS] = true;
        }
    ...
    public function setUsagetype($v)
    {
        ...
        if ($this->usagetype !== $v) {
            $this->usagetype = $v;
            $this->modifiedColumns[PaymentTableMap::COL_USAGETYPE] = true;
        }
    ...
    public function setPaymentStatus($v)
    {
        ...
        if ($this->payment_status !== $v) {
            ...
            $this->modifiedColumns[PaymentTableMap::COL_PAYMENT_STATUS] = true;
        }
    ...
    public function setReconcileStatus($v)
    {
        ...
        if ($this->reconcile_status !== $v) {
            ...
            $this->modifiedColumns[PaymentTableMap::COL_RECONCILE_STATUS] = true;
        }
    ...
    public function setCreatedDate($v)
    {
        ...
        if ($this->created_date !== null || $dt !== null) {
            if ($this->created_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PaymentTableMap::COL_CREATED_DATE] = true;
            }
        } // if either are not null
    ...
    public function setUploadstatus($v)
    {
        ...
        if ($this->uploadstatus !== $v) {
            $this->uploadstatus = $v;
            $this->modifiedColumns[PaymentTableMap::COL_UPLOADSTATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PaymentTableMap::translateFieldName('AccountNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->account_no = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PaymentTableMap::translateFieldName('Billreferencenumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billreferencenumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PaymentTableMap::translateFieldName('Transactionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transactionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PaymentTableMap::translateFieldName('Sourcebank', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sourcebank = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PaymentTableMap::translateFieldName('Destinationbank', TableMap::TYPE_PHPNAME, $indexType)];
            $this->destinationbank = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PaymentTableMap::translateFieldName('Buildingtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->buildingtype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : PaymentTableMap::translateFieldName('Customername', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customername = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : PaymentTableMap::translateFieldName('District', TableMap::TYPE_PHPNAME, $indexType)];
            $this->district = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : PaymentTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : PaymentTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : PaymentTableMap::translateFieldName('Outstandingbalance', TableMap::TYPE_PHPNAME, $indexType)];
            $this->outstandingbalance = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : PaymentTableMap::translateFieldName('Transactiondate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->transactiondate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : PaymentTableMap::translateFieldName('DateInitiated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date_initiated = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : PaymentTableMap::translateFieldName('DateCompleted', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date_completed = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : PaymentTableMap::translateFieldName('AmountPaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount_paid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : PaymentTableMap::translateFieldName('Amountdue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amountdue = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : PaymentTableMap::translateFieldName('Platform', TableMap::TYPE_PHPNAME, $indexType)];
            $this->platform = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : PaymentTableMap::translateFieldName('ReceiptNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->receipt_no = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : PaymentTableMap::translateFieldName('Serviceaddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->serviceaddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : PaymentTableMap::translateFieldName('Usagetype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usagetype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : PaymentTableMap::translateFieldName('PaymentStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : PaymentTableMap::translateFieldName('ReconcileStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reconcile_status = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : PaymentTableMap::translateFieldName('CreatedDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : PaymentTableMap::translateFieldName('Uploadstatus', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 25; // 25 = PaymentTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PaymentTableMap::COL_ACCOUNT_NO)) {
            $modifiedColumns[':p' . $index++]  = 'account_no';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_BILLREFERENCENUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'BillReferenceNumber';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_TRANSACTIONID)) {
            $modifiedColumns[':p' . $index++]  = 'TransactionID';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_SOURCEBANK)) {
            $modifiedColumns[':p' . $index++]  = 'SourceBank';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_DESTINATIONBANK)) {
            $modifiedColumns[':p' . $index++]  = 'DestinationBank';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_BUILDINGTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'BuildingType';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_CUSTOMERNAME)) {
            $modifiedColumns[':p' . $index++]  = 'CustomerName';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_DISTRICT)) {
            $modifiedColumns[':p' . $index++]  = 'District';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'Email';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'Phone';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_OUTSTANDINGBALANCE)) {
            $modifiedColumns[':p' . $index++]  = 'OutstandingBalance';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_TRANSACTIONDATE)) {
            $modifiedColumns[':p' . $index++]  = 'TransactionDate';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_DATE_INITIATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_initiated';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_DATE_COMPLETED)) {
            $modifiedColumns[':p' . $index++]  = 'date_completed';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_AMOUNT_PAID)) {
            $modifiedColumns[':p' . $index++]  = 'amount_paid';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_AMOUNTDUE)) {
            $modifiedColumns[':p' . $index++]  = 'AmountDue';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_PLATFORM)) {
            $modifiedColumns[':p' . $index++]  = 'platform';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_RECEIPT_NO)) {
            $modifiedColumns[':p' . $index++]  = 'receipt_no';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_SERVICEADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'ServiceAddress';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_USAGETYPE)) {
            $modifiedColumns[':p' . $index++]  = 'UsageType';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_PAYMENT_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'payment_status';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_RECONCILE_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'reconcile_status';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_CREATED_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'created_date';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_UPLOADSTATUS)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaymentTableMap::COL_ACCOUNT_NO)) {
            $criteria->add(PaymentTableMap::COL_ACCOUNT_NO, $this->account_no);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_BILLREFERENCENUMBER)) {
            $criteria->add(PaymentTableMap::COL_BILLREFERENCENUMBER, $this->billreferencenumber);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_TRANSACTIONID)) {
            $criteria->add(PaymentTableMap::COL_TRANSACTIONID, $this->transactionid);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_SOURCEBANK)) {
            $criteria->add(PaymentTableMap::COL_SOURCEBANK, $this->sourcebank);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_DESTINATIONBANK)) {
            $criteria->add(PaymentTableMap::COL_DESTINATIONBANK, $this->destinationbank);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_BUILDINGTYPE)) {
            $criteria->add(PaymentTableMap::COL_BUILDINGTYPE, $this->buildingtype);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_CUSTOMERNAME)) {
            $criteria->add(PaymentTableMap::COL_CUSTOMERNAME, $this->customername);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_DISTRICT)) {
            $criteria->add(PaymentTableMap::COL_DISTRICT, $this->district);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_EMAIL)) {
            $criteria->add(PaymentTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_PHONE)) {
            $criteria->add(PaymentTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_OUTSTANDINGBALANCE)) {
            $criteria->add(PaymentTableMap::COL_OUTSTANDINGBALANCE, $this->outstandingbalance);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_TRANSACTIONDATE)) {
            $criteria->add(PaymentTableMap::COL_TRANSACTIONDATE, $this->transactiondate);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_DATE_INITIATED)) {
            $criteria->add(PaymentTableMap::COL_DATE_INITIATED, $this->date_initiated);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_DATE_COMPLETED)) {
            $criteria->add(PaymentTableMap::COL_DATE_COMPLETED, $this->date_completed);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_AMOUNT_PAID)) {
            $criteria->add(PaymentTableMap::COL_AMOUNT_PAID, $this->amount_paid);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_AMOUNTDUE)) {
            $criteria->add(PaymentTableMap::COL_AMOUNTDUE, $this->amountdue);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_PLATFORM)) {
            $criteria->add(PaymentTableMap::COL_PLATFORM, $this->platform);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_RECEIPT_NO)) {
            $criteria->add(PaymentTableMap::COL_RECEIPT_NO, $this->receipt_no);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_SERVICEADDRESS)) {
            $criteria->add(PaymentTableMap::COL_SERVICEADDRESS, $this->serviceaddress);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_USAGETYPE)) {
            $criteria->add(PaymentTableMap::COL_USAGETYPE, $this->usagetype);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_PAYMENT_STATUS)) {
            $criteria->add(PaymentTableMap::COL_PAYMENT_STATUS, $this->payment_status);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_RECONCILE_STATUS)) {
            $criteria->add(PaymentTableMap::COL_RECONCILE_STATUS, $this->reconcile_status);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_CREATED_DATE)) {
            $criteria->add(PaymentTableMap::COL_CREATED_DATE, $this->created_date);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_UPLOADSTATUS)) {
            $criteria->add(PaymentTableMap::COL_UPLOADSTATUS, $this->uploadstatus);
        }
