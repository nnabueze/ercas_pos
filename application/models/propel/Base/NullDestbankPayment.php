...
/**
 * Base class that represents a row from the 'null_destbank_payment' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class NullDestbankPayment implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\NullDestbankPaymentTableMap';
    ...
    /**
     * The value for the null_destbank_payment_status field.
     *
     * Note: this column has a database default value of: 'P'
     * @var        string
     */
    protected $null_destbank_payment_status;
    ...
    {
        $this->null_destbank_payment_status = 'P';
        $this->uploadstatus = 0;
    }

    /**
     * Initializes internal state of Base\NullDestbankPayment object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>NullDestbankPayment</code> instance.  If
     * <code>obj</code> is an instance of <code>NullDestbankPayment</code>, delegates to
     * <code>equals(NullDestbankPayment)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|NullDestbankPayment The current object, for fluid interface
     */
    ...
    /**
     * Get the [null_destbank_payment_status] column value.
     *
     * @return string
     */
    public function getNullDestbankPaymentStatus()
    {
        return $this->null_destbank_payment_status;
    }
     ...
     * @return $this|\NullDestbankPayment The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_ID] = true;
        }
    ...
    public function setAccountNo($v)
    {
        ...
        if ($this->account_no !== $v) {
            $this->account_no = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_ACCOUNT_NO] = true;
        }
    ...
    public function setBillreferencenumber($v)
    {
        ...
        if ($this->billreferencenumber !== $v) {
            ...
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_BILLREFERENCENUMBER] = true;
        }
    ...
    public function setTransactionid($v)
    {
        ...
        if ($this->transactionid !== $v) {
            ...
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_TRANSACTIONID] = true;
        }
    ...
    public function setSourcebank($v)
    {
        ...
        if ($this->sourcebank !== $v) {
            $this->sourcebank = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_SOURCEBANK] = true;
        }
    ...
    public function setDestinationbank($v)
    {
        ...
        if ($this->destinationbank !== $v) {
            ...
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_DESTINATIONBANK] = true;
        }
    ...
    public function setBuildingtype($v)
    {
        ...
        if ($this->buildingtype !== $v) {
            $this->buildingtype = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_BUILDINGTYPE] = true;
        }
    ...
    public function setCustomername($v)
    {
        ...
        if ($this->customername !== $v) {
            $this->customername = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_CUSTOMERNAME] = true;
        }
    ...
    public function setDistrict($v)
    {
        ...
        if ($this->district !== $v) {
            $this->district = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_DISTRICT] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_EMAIL] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_PHONE] = true;
        }
    ...
    public function setOutstandingbalance($v)
    {
        ...
        if ($this->outstandingbalance !== $v) {
            ...
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_OUTSTANDINGBALANCE] = true;
        }
    ...
    public function setTransactiondate($v)
    {
        ...
        if ($this->transactiondate !== null || $dt !== null) {
            if ($this->transactiondate === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->transactiondate->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[NullDestbankPaymentTableMap::COL_TRANSACTIONDATE] = true;
            }
    ...
    public function setDateInitiated($v)
    {
        ...
        if ($this->date_initiated !== $v) {
            ...
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_DATE_INITIATED] = true;
        }
    ...
    public function setDateCompleted($v)
    {
        ...
        if ($this->date_completed !== $v) {
            ...
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_DATE_COMPLETED] = true;
        }
    ...
    public function setAmountPaid($v)
    {
        ...
        if ($this->amount_paid !== $v) {
            $this->amount_paid = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_AMOUNT_PAID] = true;
        }
    ...
    public function setAmountdue($v)
    {
        ...
        if ($this->amountdue !== $v) {
            $this->amountdue = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_AMOUNTDUE] = true;
        }
    ...
    public function setPlatform($v)
    {
        ...
        if ($this->platform !== $v) {
            $this->platform = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_PLATFORM] = true;
        }
    ...
    public function setReceiptNo($v)
    {
        ...
        if ($this->receipt_no !== $v) {
            $this->receipt_no = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_RECEIPT_NO] = true;
        }
    ...
    public function setServiceaddress($v)
    {
        ...
        if ($this->serviceaddress !== $v) {
            ...
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_SERVICEADDRESS] = true;
        }
    ...
    public function setUsagetype($v)
    {
        ...
        if ($this->usagetype !== $v) {
            $this->usagetype = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_USAGETYPE] = true;
        }
    ...
    /**
     * Set the value of [null_destbank_payment_status] column.
     *
     * @param string $v new value
     * @return $this|\NullDestbankPayment The current object (for fluent API support)
     */
    public function setNullDestbankPaymentStatus($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->null_destbank_payment_status !== $v) {
            $this->null_destbank_payment_status = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_NULL_DESTBANK_PAYMENT_STATUS] = true;
        }

        return $this;
    } // setNullDestbankPaymentStatus()
    ...
    public function setReconcileStatus($v)
    {
        ...
        if ($this->reconcile_status !== $v) {
            ...
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_RECONCILE_STATUS] = true;
        }
    ...
    public function setCreatedDate($v)
    {
        ...
        if ($this->created_date !== null || $dt !== null) {
            if ($this->created_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[NullDestbankPaymentTableMap::COL_CREATED_DATE] = true;
            }
        } // if either are not null
    ...
    public function setUploadstatus($v)
    {
        ...
        if ($this->uploadstatus !== $v) {
            $this->uploadstatus = $v;
            $this->modifiedColumns[NullDestbankPaymentTableMap::COL_UPLOADSTATUS] = true;
        }
    ...
    {
            if ($this->null_destbank_payment_status !== 'P') {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : NullDestbankPaymentTableMap::translateFieldName('AccountNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->account_no = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Billreferencenumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billreferencenumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Transactionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transactionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Sourcebank', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sourcebank = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Destinationbank', TableMap::TYPE_PHPNAME, $indexType)];
            $this->destinationbank = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Buildingtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->buildingtype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Customername', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customername = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : NullDestbankPaymentTableMap::translateFieldName('District', TableMap::TYPE_PHPNAME, $indexType)];
            $this->district = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Outstandingbalance', TableMap::TYPE_PHPNAME, $indexType)];
            $this->outstandingbalance = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Transactiondate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->transactiondate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : NullDestbankPaymentTableMap::translateFieldName('DateInitiated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date_initiated = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : NullDestbankPaymentTableMap::translateFieldName('DateCompleted', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date_completed = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : NullDestbankPaymentTableMap::translateFieldName('AmountPaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount_paid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Amountdue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amountdue = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Platform', TableMap::TYPE_PHPNAME, $indexType)];
            $this->platform = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : NullDestbankPaymentTableMap::translateFieldName('ReceiptNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->receipt_no = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Serviceaddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->serviceaddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Usagetype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usagetype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : NullDestbankPaymentTableMap::translateFieldName('NullDestbankPaymentStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->null_destbank_payment_status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : NullDestbankPaymentTableMap::translateFieldName('ReconcileStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reconcile_status = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : NullDestbankPaymentTableMap::translateFieldName('CreatedDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : NullDestbankPaymentTableMap::translateFieldName('Uploadstatus', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 25; // 25 = NullDestbankPaymentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\NullDestbankPayment'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildNullDestbankPaymentQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see NullDestbankPayment::setDeleted()
     * @see NullDestbankPayment::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildNullDestbankPaymentQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NullDestbankPaymentTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_ACCOUNT_NO)) {
            $modifiedColumns[':p' . $index++]  = 'account_no';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_BILLREFERENCENUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'BillReferenceNumber';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_TRANSACTIONID)) {
            $modifiedColumns[':p' . $index++]  = 'TransactionID';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_SOURCEBANK)) {
            $modifiedColumns[':p' . $index++]  = 'SourceBank';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_DESTINATIONBANK)) {
            $modifiedColumns[':p' . $index++]  = 'DestinationBank';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_BUILDINGTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'BuildingType';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_CUSTOMERNAME)) {
            $modifiedColumns[':p' . $index++]  = 'CustomerName';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_DISTRICT)) {
            $modifiedColumns[':p' . $index++]  = 'District';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'Email';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'Phone';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_OUTSTANDINGBALANCE)) {
            $modifiedColumns[':p' . $index++]  = 'OutstandingBalance';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_TRANSACTIONDATE)) {
            $modifiedColumns[':p' . $index++]  = 'TransactionDate';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_DATE_INITIATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_initiated';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_DATE_COMPLETED)) {
            $modifiedColumns[':p' . $index++]  = 'date_completed';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_AMOUNT_PAID)) {
            $modifiedColumns[':p' . $index++]  = 'amount_paid';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_AMOUNTDUE)) {
            $modifiedColumns[':p' . $index++]  = 'AmountDue';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_PLATFORM)) {
            $modifiedColumns[':p' . $index++]  = 'platform';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_RECEIPT_NO)) {
            $modifiedColumns[':p' . $index++]  = 'receipt_no';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_SERVICEADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'ServiceAddress';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_USAGETYPE)) {
            $modifiedColumns[':p' . $index++]  = 'UsageType';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_NULL_DESTBANK_PAYMENT_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'null_destBank_payment_status';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_RECONCILE_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'reconcile_status';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_CREATED_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'created_date';
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_UPLOADSTATUS)) {
            $modifiedColumns[':p' . $index++]  = 'uploadstatus';
        }

        $sql = sprintf(
            'INSERT INTO null_destbank_payment (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'UsageType':
                        ...
                        break;
                    case 'null_destBank_payment_status':
                        $stmt->bindValue($identifier, $this->null_destbank_payment_status, PDO::PARAM_STR);
                        break;
    ...
    {
        $pos = NullDestbankPaymentTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 20:
                ...
                break;
            case 21:
                return $this->getNullDestbankPaymentStatus();
                break;
            case 22:
                return $this->getReconcileStatus();
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['NullDestbankPayment'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['NullDestbankPayment'][$this->hashCode()] = true;
        $keys = NullDestbankPaymentTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[21] => $this->getNullDestbankPaymentStatus(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\NullDestbankPayment
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 20:
                ...
                break;
            case 21:
                $this->setNullDestbankPaymentStatus($value);
                break;
            case 22:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[21], $arr)) {
            $this->setNullDestbankPaymentStatus($arr[$keys[21]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_ID)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_ACCOUNT_NO)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_ACCOUNT_NO, $this->account_no);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_BILLREFERENCENUMBER)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_BILLREFERENCENUMBER, $this->billreferencenumber);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_TRANSACTIONID)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_TRANSACTIONID, $this->transactionid);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_SOURCEBANK)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_SOURCEBANK, $this->sourcebank);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_DESTINATIONBANK)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_DESTINATIONBANK, $this->destinationbank);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_BUILDINGTYPE)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_BUILDINGTYPE, $this->buildingtype);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_CUSTOMERNAME)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_CUSTOMERNAME, $this->customername);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_DISTRICT)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_DISTRICT, $this->district);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_EMAIL)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_PHONE)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_OUTSTANDINGBALANCE)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_OUTSTANDINGBALANCE, $this->outstandingbalance);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_TRANSACTIONDATE)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_TRANSACTIONDATE, $this->transactiondate);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_DATE_INITIATED)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_DATE_INITIATED, $this->date_initiated);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_DATE_COMPLETED)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_DATE_COMPLETED, $this->date_completed);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_AMOUNT_PAID)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_AMOUNT_PAID, $this->amount_paid);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_AMOUNTDUE)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_AMOUNTDUE, $this->amountdue);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_PLATFORM)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_PLATFORM, $this->platform);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_RECEIPT_NO)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_RECEIPT_NO, $this->receipt_no);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_SERVICEADDRESS)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_SERVICEADDRESS, $this->serviceaddress);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_USAGETYPE)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_USAGETYPE, $this->usagetype);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_NULL_DESTBANK_PAYMENT_STATUS)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_NULL_DESTBANK_PAYMENT_STATUS, $this->null_destbank_payment_status);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_RECONCILE_STATUS)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_RECONCILE_STATUS, $this->reconcile_status);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_CREATED_DATE)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_CREATED_DATE, $this->created_date);
        }
        if ($this->isColumnModified(NullDestbankPaymentTableMap::COL_UPLOADSTATUS)) {
            $criteria->add(NullDestbankPaymentTableMap::COL_UPLOADSTATUS, $this->uploadstatus);
        }
    ...
    {
        $criteria = ChildNullDestbankPaymentQuery::create();
        $criteria->add(NullDestbankPaymentTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \NullDestbankPayment (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNullDestbankPaymentStatus($this->getNullDestbankPaymentStatus());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \NullDestbankPayment Clone of current object.
     * @throws PropelException
     */
    ...
    public function clear()
    {
        ...
        $this->usagetype = null;
        $this->null_destbank_payment_status = null;
    ...
    {
        return (string) $this->exportTo(NullDestbankPaymentTableMap::DEFAULT_STRING_FORMAT);
    }
