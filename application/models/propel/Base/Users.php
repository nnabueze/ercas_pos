...
abstract class Users implements ActiveRecordInterface
{
    ...
    /**
     * The value for the forgotten_password_code field.
     *
     * @var        string
     */
    ...
    /**
     * The value for the forgotten_password_time field.
     *
     * @var        int
     */
    ...
    /**
     * Get the [forgotten_password_code] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [forgotten_password_time] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [forgotten_password_code] column.
     *
     * @param string $v new value
     * @return $this|\Users The current object (for fluent API support)
     */
    public function setForgottenPasswordCode($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->forgotten_password_code !== $v) {
            $this->forgotten_password_code = $v;
            $this->modifiedColumns[UsersTableMap::COL_FORGOTTEN_PASSWORD_CODE] = true;
        }
    ...
    /**
     * Set the value of [forgotten_password_time] column.
     *
     * @param int $v new value
     * @return $this|\Users The current object (for fluent API support)
     */
    public function setForgottenPasswordTime($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->forgotten_password_time !== $v) {
            $this->forgotten_password_time = $v;
            $this->modifiedColumns[UsersTableMap::COL_FORGOTTEN_PASSWORD_TIME] = true;
        }
    ...
    public function setRememberCode($v)
    {
        ...
        if ($this->remember_code !== $v) {
            ...
            $this->modifiedColumns[UsersTableMap::COL_REMEMBER_CODE] = true;
        }
    ...
    public function setCompany($v)
    {
        ...
        if ($this->company !== $v) {
            $this->company = $v;
            $this->modifiedColumns[UsersTableMap::COL_COMPANY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UsersTableMap::translateFieldName('IpAddress', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsersTableMap::translateFieldName('Salt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UsersTableMap::translateFieldName('ActivationCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->activation_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : UsersTableMap::translateFieldName('ForgottenPasswordCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->forgotten_password_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : UsersTableMap::translateFieldName('ForgottenPasswordTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->forgotten_password_time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : UsersTableMap::translateFieldName('RememberCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remember_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : UsersTableMap::translateFieldName('CreatedOn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_on = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : UsersTableMap::translateFieldName('Active', TableMap::TYPE_PHPNAME, $indexType)];
            $this->active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : UsersTableMap::translateFieldName('FirstName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->first_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : UsersTableMap::translateFieldName('LastName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : UsersTableMap::translateFieldName('Company', TableMap::TYPE_PHPNAME, $indexType)];
            $this->company = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : UsersTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_FORGOTTEN_PASSWORD_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'forgotten_password_code';
        }
        if ($this->isColumnModified(UsersTableMap::COL_FORGOTTEN_PASSWORD_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'forgotten_password_time';
        }
        if ($this->isColumnModified(UsersTableMap::COL_REMEMBER_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'remember_code';
        }
        ...
        if ($this->isColumnModified(UsersTableMap::COL_COMPANY)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'activation_code':
                        ...
                        break;
                    case 'forgotten_password_code':
                        $stmt->bindValue($identifier, $this->forgotten_password_code, PDO::PARAM_STR);
                        break;
                    case 'forgotten_password_time':
                        $stmt->bindValue($identifier, $this->forgotten_password_time, PDO::PARAM_INT);
                        break;
                    case 'remember_code':
                        $stmt->bindValue($identifier, $this->remember_code, PDO::PARAM_STR);
                        break;
                    case 'created_on':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 6:
                ...
                break;
            case 7:
                return $this->getForgottenPasswordCode();
                break;
            case 8:
                return $this->getForgottenPasswordTime();
                break;
            case 9:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[7] => $this->getForgottenPasswordCode(),
            $keys[8] => $this->getForgottenPasswordTime(),
            $keys[9] => $this->getRememberCode(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 6:
                ...
                break;
            case 7:
                $this->setForgottenPasswordCode($value);
                break;
            case 8:
                $this->setForgottenPasswordTime($value);
                break;
            case 9:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) {
            $this->setForgottenPasswordCode($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setForgottenPasswordTime($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setRememberCode($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setCreatedOn($arr[$keys[10]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_FORGOTTEN_PASSWORD_CODE)) {
            $criteria->add(UsersTableMap::COL_FORGOTTEN_PASSWORD_CODE, $this->forgotten_password_code);
        }
        if ($this->isColumnModified(UsersTableMap::COL_FORGOTTEN_PASSWORD_TIME)) {
            $criteria->add(UsersTableMap::COL_FORGOTTEN_PASSWORD_TIME, $this->forgotten_password_time);
        }
        if ($this->isColumnModified(UsersTableMap::COL_REMEMBER_CODE)) {
            $criteria->add(UsersTableMap::COL_REMEMBER_CODE, $this->remember_code);
        }
        if ($this->isColumnModified(UsersTableMap::COL_CREATED_ON)) {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_COMPANY)) {
            $criteria->add(UsersTableMap::COL_COMPANY, $this->company);
        }
        if ($this->isColumnModified(UsersTableMap::COL_PHONE)) {
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setForgottenPasswordCode($this->getForgottenPasswordCode());
        $copyObj->setForgottenPasswordTime($this->getForgottenPasswordTime());
        $copyObj->setRememberCode($this->getRememberCode());
    ...
    public function clear()
    {
        ...
        $this->forgotten_password_time = null;
