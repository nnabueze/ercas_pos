...
/**
 * Base class that represents a row from the 'payment_pos' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class PaymentPos implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PaymentPosTableMap';
    ...
    /**
     * Initializes internal state of Base\PaymentPos object.
     */
    ...
    /**
     * Compares this with another <code>PaymentPos</code> instance.  If
     * <code>obj</code> is an instance of <code>PaymentPos</code>, delegates to
     * <code>equals(PaymentPos)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PaymentPos The current object, for fluid interface
     */
     ...
     * @return $this|\PaymentPos The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_ID] = true;
        }
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_CUSTOMER_ID] = true;
        }
    ...
    public function setStationId($v)
    {
        ...
        if ($this->station_id !== $v) {
            $this->station_id = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_STATION_ID] = true;
        }
    ...
    public function setCustomerName($v)
    {
        ...
        if ($this->customer_name !== $v) {
            ...
            $this->modifiedColumns[PaymentPosTableMap::COL_CUSTOMER_NAME] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_AMOUNT] = true;
        }
    ...
    public function setBillCode($v)
    {
        ...
        if ($this->bill_code !== $v) {
            $this->bill_code = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_BILL_CODE] = true;
        }
    ...
    public function setBillName($v)
    {
        ...
        if ($this->bill_name !== $v) {
            $this->bill_name = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_BILL_NAME] = true;
        }
    ...
    public function setBillCategoryCode($v)
    {
        ...
        if ($this->bill_category_code !== $v) {
            ...
            $this->modifiedColumns[PaymentPosTableMap::COL_BILL_CATEGORY_CODE] = true;
        }
    ...
    public function setBillCategory($v)
    {
        ...
        if ($this->bill_category !== $v) {
            ...
            $this->modifiedColumns[PaymentPosTableMap::COL_BILL_CATEGORY] = true;
        }
    ...
    public function setMonth($v)
    {
        ...
        if ($this->month !== $v) {
            $this->month = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_MONTH] = true;
        }
    ...
    public function setYear($v)
    {
        ...
        if ($this->year !== $v) {
            $this->year = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_YEAR] = true;
        }
    ...
    public function setTxcode($v)
    {
        ...
        if ($this->txcode !== $v) {
            $this->txcode = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_TXCODE] = true;
        }
    ...
    public function setStation($v)
    {
        ...
        if ($this->station !== $v) {
            $this->station = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_STATION] = true;
        }
    ...
    public function setOperatorCode($v)
    {
        ...
        if ($this->operator_code !== $v) {
            ...
            $this->modifiedColumns[PaymentPosTableMap::COL_OPERATOR_CODE] = true;
        }
    ...
    public function setOperator($v)
    {
        ...
        if ($this->operator !== $v) {
            $this->operator = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_OPERATOR] = true;
        }
    ...
    public function setTerminal($v)
    {
        ...
        if ($this->terminal !== $v) {
            $this->terminal = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_TERMINAL] = true;
        }
    ...
    public function setTxdate($v)
    {
        ...
        if ($this->txdate !== $v) {
            $this->txdate = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_TXDATE] = true;
        }
    ...
    public function setTxtime($v)
    {
        ...
        if ($this->txtime !== $v) {
            $this->txtime = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_TXTIME] = true;
        }
    ...
    public function setCurrentUtc($v)
    {
        ...
        if ($this->current_utc !== $v) {
            $this->current_utc = $v;
            $this->modifiedColumns[PaymentPosTableMap::COL_CURRENT_UTC] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PaymentPosTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PaymentPosTableMap::translateFieldName('CustomerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PaymentPosTableMap::translateFieldName('StationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->station_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PaymentPosTableMap::translateFieldName('CustomerName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PaymentPosTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PaymentPosTableMap::translateFieldName('BillCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bill_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PaymentPosTableMap::translateFieldName('BillName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bill_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : PaymentPosTableMap::translateFieldName('BillCategoryCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bill_category_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : PaymentPosTableMap::translateFieldName('BillCategory', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bill_category = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : PaymentPosTableMap::translateFieldName('Month', TableMap::TYPE_PHPNAME, $indexType)];
            $this->month = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : PaymentPosTableMap::translateFieldName('Year', TableMap::TYPE_PHPNAME, $indexType)];
            $this->year = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : PaymentPosTableMap::translateFieldName('Txcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : PaymentPosTableMap::translateFieldName('Station', TableMap::TYPE_PHPNAME, $indexType)];
            $this->station = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : PaymentPosTableMap::translateFieldName('OperatorCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->operator_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : PaymentPosTableMap::translateFieldName('Operator', TableMap::TYPE_PHPNAME, $indexType)];
            $this->operator = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : PaymentPosTableMap::translateFieldName('Terminal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->terminal = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : PaymentPosTableMap::translateFieldName('Txdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : PaymentPosTableMap::translateFieldName('Txtime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtime = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : PaymentPosTableMap::translateFieldName('CurrentUtc', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 19; // 19 = PaymentPosTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PaymentPos'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPaymentPosQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PaymentPos::setDeleted()
     * @see PaymentPos::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPaymentPosQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PaymentPosTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PaymentPosTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_CUSTOMER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'customer_id';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_STATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'station_id';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_CUSTOMER_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'customer_name';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'amount';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_BILL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'bill_code';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_BILL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'bill_name';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_BILL_CATEGORY_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'bill_category_code';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_BILL_CATEGORY)) {
            $modifiedColumns[':p' . $index++]  = 'bill_category';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_MONTH)) {
            $modifiedColumns[':p' . $index++]  = 'month';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_YEAR)) {
            $modifiedColumns[':p' . $index++]  = 'year';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_TXCODE)) {
            $modifiedColumns[':p' . $index++]  = 'txcode';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_STATION)) {
            $modifiedColumns[':p' . $index++]  = 'station';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_OPERATOR_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'operator_code';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_OPERATOR)) {
            $modifiedColumns[':p' . $index++]  = 'operator';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_TERMINAL)) {
            $modifiedColumns[':p' . $index++]  = 'terminal';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_TXDATE)) {
            $modifiedColumns[':p' . $index++]  = 'txdate';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_TXTIME)) {
            $modifiedColumns[':p' . $index++]  = 'txtime';
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_CURRENT_UTC)) {
            $modifiedColumns[':p' . $index++]  = 'current_utc';
        }

        $sql = sprintf(
            'INSERT INTO payment_pos (%s) VALUES (%s)',
    ...
    {
        $pos = PaymentPosTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['PaymentPos'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PaymentPos'][$this->hashCode()] = true;
        $keys = PaymentPosTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaymentPosTableMap::COL_ID)) {
            $criteria->add(PaymentPosTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_CUSTOMER_ID)) {
            $criteria->add(PaymentPosTableMap::COL_CUSTOMER_ID, $this->customer_id);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_STATION_ID)) {
            $criteria->add(PaymentPosTableMap::COL_STATION_ID, $this->station_id);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_CUSTOMER_NAME)) {
            $criteria->add(PaymentPosTableMap::COL_CUSTOMER_NAME, $this->customer_name);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_AMOUNT)) {
            $criteria->add(PaymentPosTableMap::COL_AMOUNT, $this->amount);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_BILL_CODE)) {
            $criteria->add(PaymentPosTableMap::COL_BILL_CODE, $this->bill_code);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_BILL_NAME)) {
            $criteria->add(PaymentPosTableMap::COL_BILL_NAME, $this->bill_name);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_BILL_CATEGORY_CODE)) {
            $criteria->add(PaymentPosTableMap::COL_BILL_CATEGORY_CODE, $this->bill_category_code);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_BILL_CATEGORY)) {
            $criteria->add(PaymentPosTableMap::COL_BILL_CATEGORY, $this->bill_category);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_MONTH)) {
            $criteria->add(PaymentPosTableMap::COL_MONTH, $this->month);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_YEAR)) {
            $criteria->add(PaymentPosTableMap::COL_YEAR, $this->year);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_TXCODE)) {
            $criteria->add(PaymentPosTableMap::COL_TXCODE, $this->txcode);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_STATION)) {
            $criteria->add(PaymentPosTableMap::COL_STATION, $this->station);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_OPERATOR_CODE)) {
            $criteria->add(PaymentPosTableMap::COL_OPERATOR_CODE, $this->operator_code);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_OPERATOR)) {
            $criteria->add(PaymentPosTableMap::COL_OPERATOR, $this->operator);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_TERMINAL)) {
            $criteria->add(PaymentPosTableMap::COL_TERMINAL, $this->terminal);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_TXDATE)) {
            $criteria->add(PaymentPosTableMap::COL_TXDATE, $this->txdate);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_TXTIME)) {
            $criteria->add(PaymentPosTableMap::COL_TXTIME, $this->txtime);
        }
        if ($this->isColumnModified(PaymentPosTableMap::COL_CURRENT_UTC)) {
            $criteria->add(PaymentPosTableMap::COL_CURRENT_UTC, $this->current_utc);
        }
    ...
    {
        $criteria = ChildPaymentPosQuery::create();
        $criteria->add(PaymentPosTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PaymentPos (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PaymentPos Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PaymentPosTableMap::DEFAULT_STRING_FORMAT);
    }
