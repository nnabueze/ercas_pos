...
abstract class Otp implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OtpTableMap';
    ...
    /**
     * Initializes internal state of Base\Otp object.
     */
     ...
     * @return $this|\Otp The current object (for fluent API support)
     */
    ...
    public function setAccountNo($v)
    {
        ...
        if ($this->account_no !== $v) {
            $this->account_no = $v;
            $this->modifiedColumns[OtpTableMap::COL_ACCOUNT_NO] = true;
        }
    ...
    /**
     * Set the value of [opt] column.
     *
     * @param int $v new value
     * @return $this|\Otp The current object (for fluent API support)
     */
    public function setOpt($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->opt !== $v) {
            $this->opt = $v;
            $this->modifiedColumns[OtpTableMap::COL_OPT] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[OtpTableMap::COL_STATUS] = true;
        }
    ...
    public function setDateCreated($v)
    {
        ...
        if ($this->date_created !== null || $dt !== null) {
            if ($this->date_created === null || $dt === null || $dt->format("Y-m-d") !== $this->date_created->format("Y-m-d")) {
                ...
                $this->modifiedColumns[OtpTableMap::COL_DATE_CREATED] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OtpTableMap::translateFieldName('AccountNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->account_no = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OtpTableMap::translateFieldName('Opt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->opt = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OtpTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OtpTableMap::translateFieldName('DateCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = OtpTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Otp'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OtpTableMap::COL_ACCOUNT_NO)) {
            $modifiedColumns[':p' . $index++]  = 'account_no';
        }
        if ($this->isColumnModified(OtpTableMap::COL_OPT)) {
            $modifiedColumns[':p' . $index++]  = 'opt';
        }
        if ($this->isColumnModified(OtpTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'Status';
        }
        if ($this->isColumnModified(OtpTableMap::COL_DATE_CREATED)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'account_no':
                        ...
                        break;
                    case 'opt':
                        $stmt->bindValue($identifier, $this->opt, PDO::PARAM_INT);
                        break;
                    case 'Status':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OtpTableMap::COL_ACCOUNT_NO)) {
            $criteria->add(OtpTableMap::COL_ACCOUNT_NO, $this->account_no);
        }
        if ($this->isColumnModified(OtpTableMap::COL_OPT)) {
            $criteria->add(OtpTableMap::COL_OPT, $this->opt);
        }
        if ($this->isColumnModified(OtpTableMap::COL_STATUS)) {
            $criteria->add(OtpTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(OtpTableMap::COL_DATE_CREATED)) {
            $criteria->add(OtpTableMap::COL_DATE_CREATED, $this->date_created);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Otp (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Otp Clone of current object.
     * @throws PropelException
     */
